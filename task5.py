...
i = input("Введите, в какой вагон с головы состава сел Витя")
j = input("Введите номер вагона в какой сел Витя")

if i != j:
    print(i + j - 1)
else:
    print("без дополнительной информации невозможно определить число вагонов")
